          ...
          >
            ...
            >
              <Icon
                icon={locationIcon}
                width={
                  styles?.AppBarLocationIconWidth?.value != ""
                    ? styles?.AppBarLocationIconWidth?.value
                    : themeColors?.AppBarLocationIconWidth?.value
                }
                height={
                  styles?.AppBarLocationIconHeight?.value != ""
                    ? styles?.AppBarLocationIconHeight?.value
                    : themeColors?.AppBarLocationIconHeight?.value
                }
                color={
            ...
            >
              <Icon
                ...
                width={
                  styles?.AppBarPhoneIconWidth?.value != ""
                    ? styles?.AppBarPhoneIconWidth?.value
                    : themeColors?.AppBarPhoneIconWidth?.value
                }
                height={
                  styles?.AppBarPhoneIconHeight?.value != ""
                    ? styles?.AppBarPhoneIconHeight?.value
                    : themeColors?.AppBarPhoneIconHeight?.value
                }
                color={
          ...
          <Box style={{ position: "relative" }}>
            <IconButton onClick={actions.handleOpenCart}>
              <Icon
                ...
                width={
                  styles?.AppBarCartIconWidth?.value != ""
                    ? styles?.AppBarCartIconWidth?.value
                    : themeColors?.AppBarCartIconWidth?.value
                }
                height={
                  styles?.AppBarCartIconHeight?.value != ""
                    ? styles?.AppBarCartIconHeight?.value
                    : themeColors?.AppBarCartIconHeight?.value
                }
